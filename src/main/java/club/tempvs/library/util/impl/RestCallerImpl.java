...
public class RestCallerImpl implements RestCaller {
    ...
    public <T> T call(String uri, HttpMethod method, T payload, Class<T> responseType) {
        ...
        return restTemplate.exchange(urlPrefix + uri, method, httpEntity, responseType).getBody();
    }
}
